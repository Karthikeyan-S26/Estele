...
@if($categories->isNotEmpty())
  <section class="bg-ivory py-6 md:py-9">
    <div class="mx-auto w-full max-w-wrapper px-3 md:px-4">
      ...
      <div class="relative" data-carousel data-loop>
        <button class="absolute -left-1 top-[calc(50%-14px)] z-[3] grid h-7 w-7 -translate-y-1/2 place-items-center rounded-full border border-line bg-white text-heading shadow-sm transition-colors hover:border-rose hover:bg-rose hover:text-white md:-left-2 md:top-1/2 md:h-10 md:w-10 xl:-left-[18px]" type="button" data-carousel-prev aria-label="Previous">
        ...
        <button class="absolute -right-1 top-[calc(50%-14px)] z-[3] grid h-7 w-7 -translate-y-1/2 place-items-center rounded-full border border-line bg-white text-heading shadow-sm transition-colors hover:border-rose hover:bg-rose hover:text-white md:-right-2 md:top-1/2 md:h-10 md:w-10 xl:-right-[18px]" type="button" data-carousel-next aria-label="Next">
